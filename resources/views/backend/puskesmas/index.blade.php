        ...
        <div class="card-header mb-3">
            <div class="d-flex align-items-start">
                ...
                <div class="flex-shrink-0">
                    <a class="btn btn-primary " href="{{ route('backend.puskesmas.create') }}">
                        Tambah
...
@section('script')
  ...
  <script>
    ...
    let dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: {
          url: "{{ route('backend.puskesmas.index') }}",
          data: function (d) {
        ...
        //   {data: 'image', name: 'image'},
          {data: 'name', name: 'name'},
          {data: 'wilayah.alamat', name: 'wilayah.alamat'},
      ...
      modalDelete.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('.urlDelete').setAttribute('href', '{{ route("backend.puskesmas.index") }}/' + id);
      });
