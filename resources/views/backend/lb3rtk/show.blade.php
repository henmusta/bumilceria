...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    ...
    <div class="card-body" id="printableArea">
         ...
         <table width="100%">
            <tr>
              <td style="width: 50%; font-weight: bold; font-size: 12px; text-align: left"> Data LB3 Risiko Tinggi Komplikasi - {{$data['lb3rtk']['puskesmas']['name']}} - {{$data['lb3rtk']['tahun']->isoFormat('MMMM YYYY')}}</td>
