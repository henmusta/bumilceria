                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" value="{{ $data['lb3rtk']['tahun'] }}" placeholder="Pilih Tahun" id="tahun" name="tahun">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-8">
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" value="{{ $data['lb3rtk']['lain-lain'] }}"  name="lain-lain">
                                    </div>
                                  </div>
                            </div>
                            <div class="col-2"></div>
