        ...
        <script src="{{ asset('assets/backend/vendor_components/autoNumeric/autonumeric.js') }}"></script> --}}
    ...
    <script src="{{asset('assets/backend/dist/libs/owl.carousel/dist/owl.carousel.min.js')}}"></script>

    <script src="{{asset('assets/backend/dist/libs/datatables.net/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('assets/backend/cdn.datatables.net/buttons/1.5.1/js/dataTables.buttons.min.js')}}"></script>
    <script src="{{asset('assets/backend/cdn.datatables.net/buttons/1.5.1/js/buttons.flash.min.js')}}"></script>
    <script src="{{asset('assets/backend/cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js')}}"></script>
    <script src="{{asset('assets/backend/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.32/pdfmake.min.js')}}"></script>
    <script src="{{asset('assets/backend/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.32/vfs_fonts.js')}}"></script>
    <script src="{{asset('assets/backend/cdn.datatables.net/buttons/1.5.1/js/buttons.html5.min.js')}}"></script>
    <script src="{{asset('assets/backend/cdn.datatables.net/buttons/1.5.1/js/buttons.print.min.js')}}"></script>
    <script src="{{asset('assets/backend/dist/js/datatable/datatable-advanced.init.js')}}"></script> --}}
    ...
    <script src="{{asset('assets/backend/dist/js/custom.js')}}"></script>
    <script src="{{asset('assets/backend/dist/libs/prismjs/prism.js')}}"></script>
    ...
    <script src="{{asset('assets/backend/dist/libs/select2/dist/js/select2.full.min.js')}}"></script>
    <script src="{{asset('assets/backend/dist/libs/select2/dist/js/select2.min.js')}}"></script>
    <script src="{{asset('assets/backend/dist/js/forms/select2.init.js')}}"></script>
<script></script>
        @yield('script')
