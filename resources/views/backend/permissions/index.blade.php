    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="Datatable" class="table border table-striped table-bordered display text-nowrap" style="width:100%">
                    <thead>
                        <tr>
                            <th>Nama</th>
                            <th>Path Url</th>
      ...
      <div class="modal-content">
        ...
        <form id="formStore" method="POST" action="">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
                <label for="activeSelect">type<span class="text-danger">*</span></label>
                <select class="form-select select2" id="typeSelect" name="type">
  ...
  <script>
     $(document).ready(function () {
      ...
      modalEdit.addEventListener('show.bs.modal', function (event) {
        ...
        let type = event.relatedTarget.getAttribute('data-bs-type');
        ...
        this.querySelector('select[name=type]').value = type;
