...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    ...
    <div class="card-body" id="printableArea">
         ...
         <table width="100%">
            <tr>
              <td style="width: 50%; font-weight: bold; font-size: 12px; text-align: left"> Data LB3 Balita - {{$data['lb3balita']['puskesmas']['name']}} - {{$data['lb3balita']['tanggal']->isoFormat('MMMM YYYY')}}</td>
