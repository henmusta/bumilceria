...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="row row-sm">
        <div class="col-lg-12 col-md-12">
            <form id="formStore" action="{{ route('backend.lb3ibubersalin.store') }}" autocomplete="off">
                @csrf
                        ...
                        <div class="col-8">
                            <div class="d-flex flex-column">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control"  name="ibu_bersalin_nakes">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control"  name="ibu_bersalin_faskes">
                                </div>

                                <div class="mb-3">
                                    <label for="Nama">KF1<span class="text-danger">*</span></label>
                                    <p style="font-size:10px;">Jumlah kunjungan nifas KF1</p>
                                    <input type="number" class="form-control"  name="kf1">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control"  name="kf_lengkap">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control"  name="vita_ibu_nifas">
                                </div>
