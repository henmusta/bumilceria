...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    ...
    <div class="card-body" id="printableArea">
         ...
         <table width="100%">
            <tr>
              <td style="width: 50%; font-weight: bold; font-size: 12px; text-align: left"> Data Lb3 Ibu Bersalin - {{$data['lb3ibubersalin']['puskesmas']['name']}} - {{\Carbon\Carbon::parse($data['lb3ibubersalin']['tanggal'])->isoFormat('MMMM YYYY')}}</td>
