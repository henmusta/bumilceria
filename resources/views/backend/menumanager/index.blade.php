              ...
              <div class="card" style="border-radius: 0 !important;">
                <div class="card-body">
                  <div class="mb-3 d-flex flex-row justify-content-center align-items-center">
                    ...
                    <select class="form-control" id="select2Role" style="width: 30% !important;" name="roleId">
...
@section('css')
  <link href="{{ asset('assets/backend/dist/libs/nestable/nestable.css') }}" rel="stylesheet" type="text/css"/>
@endsection
@section('script')
  <script src="{{ asset('assets/backend/dist/libs/nestable/nestable.js') }}" type="text/javascript"></script>
  <script>
