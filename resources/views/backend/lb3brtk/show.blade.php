...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    ...
    <div class="card-body" id="printableArea">
         ...
         <table width="100%">
            <tr>
              <td style="width: 50%; font-weight: bold; font-size: 12px; text-align: left"> Data LB3 Bayi Resiko Tinggi Komplikasi - {{$data['lb3brtk']['puskesmas']['name']}} - {{$data['lb3brtk']['tanggal']->isoFormat('MMMM YYYY')}}</td>
