                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select id="select2Datepicker" style="width: 100% !important;" name="tanggal">
                                  <option value="{{ $data['lb3brtk']['tanggal'] }}">{{ \Carbon\Carbon::parse($data['lb3brtk']['tanggal'])->isoFormat('MMMM YYYY') }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-8">
                            <div class="d-flex flex-column">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" value="{{ $data['lb3brtk']['lain_lain'] }}"  name="lain-lain">
                                </div>
