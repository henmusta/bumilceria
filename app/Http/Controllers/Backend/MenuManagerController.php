...
//    $this->middleware('can:dkmp-menu-delete', ['only' => ['destroy']]);
  ...
  public function index(Request $request)
  {
    ...
    return view('backend.menumanager.index', compact('config', 'page_breadcrumbs', 'role', 'sortable', 'data'));
  }
  ...
  public function edit($id, Request $request)
  {
    ...
    return view('backend.menumanager.index', compact('config', 'page_breadcrumbs', 'data', 'permissions', 'role', 'sortable'));
  }
    ...
    foreach ($roots as $item) {
      ...
      <li class="dd-item dd3-item" data-id="' . $item->id . '">
        ...
        <div class="dd3-actions">
          <div class="btn-group">
            <a href="#" style="font-size:12px" class="btn btn-sm font-weight-bold">' . ($item->menu_permission_id ? "<span style='color:green; font-weight:bold'>Fixed</span>" : "<span style='color:red; font-weight:bold'>Statis</span>") . '</a>
            <a href="/backend/menu/' . $item->id . '/edit?role_id=' . $roleId . '" style="height:30px; font-size:10px" class="btn mb-1 waves-effect waves-light ' . ($item->menu_permission_id ? " btn-outline-success" : "btn-outline-danger") . '"
              ><i class="fa fa-fw fa-edit"></i> Ubah
            </a>
            <button
              type="button" style="height:30px; font-size:10px"
              class="btn mb-1 waves-effect waves-light btn-outline-info"
              data-bs-id="' . $item->id . '"
